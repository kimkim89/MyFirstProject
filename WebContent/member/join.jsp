		...
		<div class="container" id="mem_join_con">
			...
			<fieldset id="mem_join">
				...
				<ul id="id_sec">
					...
					<label for="id"><b>ID</b>
						<span id="id_sp2">
								*아이디는 4~12자의 영문 대소문자와 숫자만 가능합니다 
						</span> 
					</label> 
						<input type="text" placeholder="Enter Id" onkeydown="inputIdChk()" name="id" id="id" required>
			 	  	</li>
					<li>
						<button type="button" class="idchbtn" id="BTN_USERID_CHECK" onclick="winopen();">ID 중복체크</button> 
						<input type="hidden" name="idDuplication" value="idUncheck">
					</li>
				</ul>
				<br><br><br><br><br> 
				<label for="passwd"><b>Password</b>
					<span id="pass_sp1"> *비밀번호는 4~12자의 영문 대소문자와 숫자만 가능합니다 <br></span> 
					<span id="pass_sp2"> *비밀번호에는 하나이상의 문자와 숫자가 포함되어야 합니다.</span> 
				</label> 
				...
				</label> <input type="password" placeholder="Repeat Password" name="pass-repeat" id="pass-repeat" required>
			...
			<fieldset>
				...
				<label> 
					<input type="text" id="sample6_postcode" name="zipcode" placeholder="우편번호" readonly="readonly" style="width: 50%">
					&nbsp; &nbsp; 
					<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" id="postcode_btn"><br>
				</label> 
					<input type="text" id="sample6_address" name="address1" placeholder="주소" readonly="readonly"> 
					<input type="text" id="sample6_address2" name="address2" placeholder="상세주소">
			</fieldset>


			<div class="clearfix">
				<button type="button" class="signupbtn" id="btnSend" onclick="contrats()">회원가입</button>
				<button type="reset" class="cancelbtn">가입취소</button>
